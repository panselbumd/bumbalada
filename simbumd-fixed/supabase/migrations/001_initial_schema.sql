...
-- ============================================================
-- ENUM TYPES
-- Dibuat dengan DO block agar tidak error jika sudah ada,
-- lalu ADD VALUE IF NOT EXISTS untuk memastikan semua nilai tersedia.
-- ============================================================
...
-- Pastikan semua nilai user_role ada (aman jika sudah ada)
DO $$ BEGIN ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'superadmin';        EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'admin';             EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'panitia_seleksi';   EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'penilai';           EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'viewer_eksekutif';  EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE user_role ADD VALUE IF NOT EXISTS 'bumd_operator';     EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE user_status ADD VALUE IF NOT EXISTS 'aktif';    EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE user_status ADD VALUE IF NOT EXISTS 'nonaktif'; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE user_status ADD VALUE IF NOT EXISTS 'pending';  EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE bumd_type ADD VALUE IF NOT EXISTS 'perseroda'; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE bumd_type ADD VALUE IF NOT EXISTS 'perumda';   EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE health_level ADD VALUE IF NOT EXISTS 'sehat';        EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE health_level ADD VALUE IF NOT EXISTS 'kurang_sehat'; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE health_level ADD VALUE IF NOT EXISTS 'tidak_sehat';  EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE auditor_opinion ADD VALUE IF NOT EXISTS 'WTP';     EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE auditor_opinion ADD VALUE IF NOT EXISTS 'WTP_DPP'; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE auditor_opinion ADD VALUE IF NOT EXISTS 'WDP';     EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE auditor_opinion ADD VALUE IF NOT EXISTS 'TMP';     EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE auditor_opinion ADD VALUE IF NOT EXISTS 'belum';   EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE kpi_status ADD VALUE IF NOT EXISTS 'melebihi_target'; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE kpi_status ADD VALUE IF NOT EXISTS 'tercapai';        EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE kpi_status ADD VALUE IF NOT EXISTS 'tidak_tercapai';  EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE seleksi_status ADD VALUE IF NOT EXISTS 'draft';                EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE seleksi_status ADD VALUE IF NOT EXISTS 'dibuka';               EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE seleksi_status ADD VALUE IF NOT EXISTS 'seleksi_administrasi'; EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE seleksi_status ADD VALUE IF NOT EXISTS 'ukk';                  EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE seleksi_status ADD VALUE IF NOT EXISTS 'wawancara';            EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE seleksi_status ADD VALUE IF NOT EXISTS 'selesai';              EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE seleksi_status ADD VALUE IF NOT EXISTS 'dibatalkan';           EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'terdaftar';               EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'review_dokumen';          EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'lolos_administrasi';      EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'tidak_lolos_administrasi';EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'lolos_ukk';               EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'tidak_lolos_ukk';         EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'lolos_wawancara';         EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'tidak_lolos_wawancara';   EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE peserta_status ADD VALUE IF NOT EXISTS 'ditetapkan';              EXCEPTION WHEN others THEN NULL; END $$;
...
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'login';           EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'logout';          EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'create';          EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'update';          EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'delete';          EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'export';          EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'submit_laporan';  EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'reset_password';  EXCEPTION WHEN others THEN NULL; END $$;
DO $$ BEGIN ALTER TYPE log_action ADD VALUE IF NOT EXISTS 'change_role';     EXCEPTION WHEN others THEN NULL; END $$;

-- ============================================================
-- TABEL: profiles (extends auth.users)
-- DEFAULT pakai cast eksplisit untuk menghindari invalid input value
-- ============================================================
...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  email         TEXT NOT NULL,
  role          user_role NOT NULL DEFAULT 'viewer_eksekutif'::user_role,
  unit_kerja    TEXT,
  jabatan       TEXT,
  no_hp         VARCHAR(20),
  avatar_url    TEXT,
...
CREATE TABLE IF NOT EXISTS laporan_kinerja_bumd (
  ...
  opini_auditor        auditor_opinion DEFAULT 'belum'::auditor_opinion,
  catatan              TEXT,
...
CREATE TABLE IF NOT EXISTS proses_seleksi (
  ...
  status            seleksi_status NOT NULL DEFAULT 'draft'::seleksi_status,
...
CREATE TABLE IF NOT EXISTS peserta_seleksi (
  ...
  status             peserta_status NOT NULL DEFAULT 'terdaftar'::peserta_status,
...
RETURNS BOOLEAN AS $$
  SELECT get_user_role() IN ('superadmin'::user_role, 'admin'::user_role);
$$ LANGUAGE sql SECURITY DEFINER STABLE;
...
CREATE POLICY "laporan_bumd_write" ON laporan_kinerja_bumd FOR ALL    USING (is_admin() OR get_user_role() = 'bumd_operator'::user_role);
CREATE POLICY "laporan_blud_read"  ON laporan_kinerja_blud FOR SELECT USING (auth.uid() IS NOT NULL);
CREATE POLICY "laporan_blud_write" ON laporan_kinerja_blud FOR ALL    USING (is_admin() OR get_user_role() = 'bumd_operator'::user_role);
...
CREATE POLICY "kpi_write" ON kpi_bumd FOR ALL    USING (is_admin() OR get_user_role() = 'bumd_operator'::user_role);
...
CREATE POLICY "seleksi_panitia_write" ON proses_seleksi FOR ALL    USING (is_admin() OR get_user_role() = 'panitia_seleksi'::user_role);
...
CREATE POLICY "peserta_read_panitia" ON peserta_seleksi FOR SELECT
  USING (auth.uid() IS NOT NULL AND get_user_role() IN (
    'superadmin'::user_role,'admin'::user_role,'panitia_seleksi'::user_role,'penilai'::user_role
  ));
CREATE POLICY "peserta_write_panitia" ON peserta_seleksi FOR ALL
  USING (is_admin() OR get_user_role() = 'panitia_seleksi'::user_role);
...
CREATE POLICY "dokumen_panitia_read" ON dokumen_peserta FOR SELECT
  USING (get_user_role() IN ('superadmin'::user_role,'admin'::user_role,'panitia_seleksi'::user_role));
...
CREATE POLICY "ukk_read_admin"    ON penilaian_ukk FOR SELECT USING (is_admin() OR get_user_role() = 'panitia_seleksi'::user_role);
