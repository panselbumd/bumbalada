...
-- END STEP 1
-- ============================================================
-- Setelah STEP 1 berhasil, lanjutkan ke STEP 2 di bawah ini.
-- Salin dari "BEGIN STEP 2" sampai akhir file, jalankan terpisah.
-- ============================================================

-- BEGIN STEP 2
-- ============================================================
-- STEP 2: TABEL, INDEX, RLS, FUNGSI, TRIGGER, SEED DATA
-- ============================================================
...
CREATE POLICY "seleksi_panitia_write" ON proses_seleksi FOR ALL    USING (is_admin() OR get_user_role() = 'panitia_seleksi');
...
INSERT INTO bumd (kode, nama, singkatan, jenis, direktur) VALUES
  ...
  ('PDAM', 'Perumdam Among Tirto',            'Perumdam',      'perumda',   'Moch. Yusuf, SAP'),
...
INSERT INTO blud (kode, nama, singkatan, jenis) VALUES
  ...
  ('PKM-C', 'Puskesmas BLUD Sisir',               'PKM Sisir',   'puskesmas'),
  ('PKM-D', 'Puskesmas BLUD Beji',                'PKM Beji',    'puskesmas'),
  ('PKM-E', 'Puskesmas BLUD Junrejo',             'PKM Junrejo', 'puskesmas'),
ON CONFLICT (kode) DO NOTHING;
